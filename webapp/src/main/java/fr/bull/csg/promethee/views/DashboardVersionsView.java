...
/**
 * Vue principale de listing des versions en cours et de leurs états.
 * @author martiben
 */
...
public class DashboardVersionsView extends VerticalLayout implements View
{
   ...
   /** Bean relativement inutile permettant de tester l'intégration de Spring dans Vaadin. */
   @Autowired
   ...
   /** Valorisation des composants graphiques. */
   private void valoComposants()
   {
      // Valorisation des versions et test de récupération d'un bean
      List<String> arrayVersions = m_listeurVersions.listerLesVersionsDisponibles();
      System.out.println("Dash=" + arrayVersions);
      ...
      // Affiche seulement les lignes remplies dans les tableaux
      table_1.setPageLength(0);
      table_2.setPageLength(0);
      table_3.setPageLength(0);

      // Valorisation des noms de colonnes
   ...
   /**
    * Méthode permettant de remplir un objet graphique "table" à partir d'une liste de tableaux d'objects.
    * @param p_listeMantis Une liste de tableau d'objects (un tableau d'object = 1 ligne dans la table)
    * @param p_table l'objet graphique table à remplir
    */
   ...
   // A partir d'ici, c'est du généré par le GUI Builder modulo les valeurs en dur des composants graphiques.
   @AutoGenerated
